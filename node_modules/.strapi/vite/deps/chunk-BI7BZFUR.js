...
} from "./chunk-ZFV4ELXS.js";
import {
  useTypedSelector
} from "./chunk-3R5HT5QT.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-XSAUHUV6.js";
import {
  useConfig
} from "./chunk-FCLIJIXB.js";
import {
  AssetSource,
  AssetType,
  ...
  pluginPkg,
  viewOptions
} from "./chunk-T5V4UT6Q.js";
import {
  PERMISSIONS as PERMISSIONS2
} from "./chunk-PDGPTUUZ.js";
import {
  useDocumentActions
} from "./chunk-YBVLVZGU.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-CBG7SUE5.js";
import {
  PERMISSIONS,
  reducer,
  reducer2
} from "./chunk-RO6B6N4I.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  renderAdmin
} from "./chunk-2I627FPA.js";
import {
  useLicenseLimits
} from "./chunk-K6G434I2.js";
import {
  require_omit
} from "./chunk-HMK5KCER.js";
import {
  require_cloneDeep
...
import {
  ...
  Formik,
  useFormik
} from "./chunk-4S663EA7.js";
import {
  create3 as create,
  create4 as create2,
  create6 as create3,
  require_has
} from "./chunk-D6TU5LYD.js";
import {
  useTracking
...
import {
  Table,
  useTable
} from "./chunk-BEIN36ZT.js";
import {
  useField,
  useForm
} from "./chunk-2LW7YCMH.js";
import {
  useRBAC
} from "./chunk-OBYG3BLK.js";
import {
  useAdminUsers
} from "./chunk-57N2SCQG.js";
import {
  ForwardRef$J,
  Page,
  useAPIErrorHandler
} from "./chunk-TKNBHXFW.js";
import {
  useAuth,
  useQueryParams
} from "./chunk-HAGJJFVR.js";
import {
  isFetchError,
  require_get,
  require_lib,
  skipToken
} from "./chunk-37UIT6AH.js";
import {
  useNotification
} from "./chunk-F77XFYRA.js";
import {
  Badge,
  Box,
  Button,
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-NXT6QL3U.js");
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-QSNRWS5C.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-VEMQJ4KC.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-23BYL6MB.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-3J3TAKMJ.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-SQD4WMVB.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en.json-77PLR44Q.js");
    case "./translations/uk.json":
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-E4VWSWKY.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-UALGDN3L.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-RZYV7AWA.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-LSE2AYCT.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-POL4VLJ3.js");
          return {
...
//# sourceMappingURL=chunk-BI7BZFUR.js.map
