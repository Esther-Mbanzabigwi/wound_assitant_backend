...
import {
  reducer
} from "./chunk-NBD4UIYW.js";
import {
  DEFAULT_BULK_ACTIONS,
  DEFAULT_TABLE_ROW_ACTIONS
} from "./chunk-YSSDMVW2.js";
import {
  ActionsPanel,
  DEFAULT_ACTIONS,
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-SJX4EWDG.js");
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-4EQRC2ZB.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register([
      {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-6VKXKNSH.js");
      ...
      },
      {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-6VKXKNSH.js");
...
var DeleteReleaseActionItem = ({ releaseId, actionId }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(Menu.Item, {
    variant: "danger",
    startIcon: (0, import_jsx_runtime4.jsx)(ForwardRef$45, {}),
...
var ReleaseActionEntryLinkItem = ({ contentTypeUid, documentId, locale }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(StyledMenuLink, {
    ...
    startIcon: (0, import_jsx_runtime4.jsx)(ForwardRef$1v, {}),
    children: formatMessage({
...
//# sourceMappingURL=chunk-TANZRRNF.js.map
